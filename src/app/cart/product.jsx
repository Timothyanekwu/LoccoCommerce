...
const CartProduct = ({ name, price, img }) => {
  return (
    <div className="w-full h-fit p-3 border-b border-b-[#545454] flex justify-between">
      <div className="flex items-start">
        ...
        <div>
          ...
          <div className="flex items-center mt-4">
            <div className="bg-neutral-200 hover:bg-[#4D4875] hover:text-white text-black text-xl w-6 h-6 flex items-center justify-center rounded-sm">
              +
            </div>
      ...
      <div className="flex justify-center items-start h-full cursor-pointer">
